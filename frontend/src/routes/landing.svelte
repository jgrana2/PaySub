...
<!-- Assuming this is inside your main Svelte component or a relevant container component -->
<main class="max-w-4xl mx-auto p-6">

    <!-- Create Your Subscription Package Section -->
    <section class="mb-8">
      <h2 class="text-2xl font-bold mb-4">Create Your Subscription Package in Minutes</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <!-- Feature Box 1 -->
        <div class="p-4 bg-white rounded shadow-md">
          <h3 class="text-lg font-semibold mb-2">Easy Setup</h3>
          <p class="text-gray-700">
            Are you a content creator? Offer premium content effortlessly with [Your Subscription Service Name]. Create a personalized subscription package tailored to your audience's needs with just a few clicks.
          </p>
        </div>
  
        <!-- Feature Box 2 -->
        <div class="p-4 bg-white rounded shadow-md">
          <h3 class="text-lg font-semibold mb-2">Flexibility</h3>
          <p class="text-gray-700">
            Whether it's early access, exclusive updates, or special perks, design a subscription that fits your brand. [Your Subscription Service Name] gives you the flexibility to deliver content the way you want.
          </p>
        </div>
      </div>
    </section>
  
    <!-- Seamless Subscription Experience Section -->
    <section class="mb-8">
      <h2 class="text-2xl font-bold mb-4">Seamless Subscription Experience for Your Customers</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <!-- Feature Box 3 -->
        <div class="p-4 bg-white rounded shadow-md">
          <h3 class="text-lg font-semibold mb-2">Straightforward Process</h3>
          <p class="text-gray-700">
            Empower your customers with a straightforward subscription process. Share a unique link, and let them easily access and subscribe to your offerings.
          </p>
        </div>
  
        <!-- Feature Box 4 -->
        <div class="p-4 bg-white rounded shadow-md">
          <h3 class="text-lg font-semibold mb-2">User-Friendly</h3>
          <p class="text-gray-700">
            The entire process is designed to be user-friendly, ensuring a smooth experience for both you and your subscribers.
          </p>
        </div>
      </div>
    </section>
  
    <!-- Hassle-Free Payments and Management Section -->
    <section class="mb-8">
      <h2 class="text-2xl font-bold mb-4">Hassle-Free Payments and Management</h2>
      <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        <!-- Feature Box 5 -->
        <div class="p-4 bg-white rounded shadow-md">
          <h3 class="text-lg font-semibold mb-2">One-Click Subscription</h3>
          <p class="text-gray-700">
            For your subscribers, it's as simple as clicking a link and enjoying the benefits. If they're already registered and have a payment method, the subscription is done in one click.
          </p>
        </div>
  
        <!-- Feature Box 6 -->
        <div class="p-4 bg-white rounded shadow-md">
          <h3 class="text-lg font-semibold mb-2">Secure Payment Setup</h3>
          <p class="text-gray-700">
            If not, our system guides them through a quick and secure payment setup. Managing your subscribers is a breeze with our integrated system that keeps everything organized.
          </p>
        </div>
      </div>
    </section>
  
    <!-- Connect and Grow with API Integration Section -->
    <section>
      <h2 class="text-2xl font-bold mb-4">Connect and Grow with API Integration</h2>
      <div class="p-4 bg-white rounded shadow-md">
        <h3 class="text-lg font-semibold mb-2">Seamless Integration</h3>
        <p class="text-gray-700">
          Take your subscription management to the next level by seamlessly integrating [Your Subscription Service Name] with your website through our API. Connect and manage your subscribers effortlessly, gaining valuable insights and analytics to help you grow your brand.
        </p>
      </div>
    </section>
